<template>
    <el-card>
            ...
            <div class="flex flex-row justify-between">
                ...
                <div class="flex flex-row space-x-10">
                    ...
                    <el-button
                        ...
                        :key="item"
                        @click="onTabeleActionClick(item.onclick)"
                        >{{ item.name }}</el-button
                    >
                </div>
        ...
        <el-table :data="tableData" v-show="fields" ref="baseTable">
            <el-table-column
        ...
        <el-dialog v-model="dialogVisible" width="500px" :title="name">
            <el-form>
                <div v-for="item in dialogField" :key="item">
                    <el-form-item
                        :label="item.alias + ':'"
                        v-if="item.type === 'text'"
                    >
            ...
            <template #footer>
                <div>
                    <el-button @click="this.dialogVisible = false"
                        >取消</el-button
                    >
                    <el-button @click="this.storeData()" type="success"
                        >保存</el-button
                    >
                </div>
            </template>
...
export default {
    ...
    methods: {
        ...
        storeData() {
            ...
            this.$store
                .dispatch(
                    this.namespace + "/" + MutationType.STORE_DATA,
                    formData
                )
                .then(() => {
                    that.form = {};
