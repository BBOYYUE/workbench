    ...
    <base-layout>
        <template v-slot:header>
            <base-header
                ...
                @toggleLeftMenuCollapse="toggleLeftMenuCollapse"
            ></base-header>
        </template>
        <template v-slot:left-menu>
            <base-left-menu
                :menu="leftMenu"
                :leftMenuCollapse="leftMenuCollapse"
                @menuItemClick="leftMenuItemClick"
            ></base-left-menu>
        </template>
        ...
        -->
                <base-list v-show="activeType == 1" :modelId="activeModuleId" />
                <base-detail
                    v-show="activeType == 2"
    ...
    computed: mapState({
        ...
        isSelfCorrelation() {
            return this.activeModule
                ? this.activeModule.isSelfCorrelation
                : false;
        },
